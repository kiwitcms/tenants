...
if 'tenant_navbar_processor' not in TEMPLATES[['OPTIONS'['context_processors']]]:   # noqa: F821
    TEMPLATES[['OPTIONS'['context_processors']]].append('tenant_navbar_processor')  # noqa: F821
